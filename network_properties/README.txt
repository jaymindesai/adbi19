...
Usage:
$SPARK_HOME/bin/spark-submit --packages graphframes:graphframes:0.1.0-spark1.6 degree.py [filename [large]]

Example:

$SPARK_HOME/bin/spark-submit --packages graphframes:graphframes:0.1.0-spark1.6 degree.py ./stanford_graphs/amazon.graph.large large

$SPARK_HOME/bin/spark-submit --packages graphframes:graphframes:0.1.0-spark1.6 degree.py ./stanford_graphs/amazon.graph.small
...
Usage:
	$SPARK_HOME/bin/spark-submit --packages graphframes:graphframes:0.1.0-spark1.6 centrality.py
Notes:
...
Usage:
	$SPARK_HOME/bin/spark-submit --packages graphframes:graphframes:0.1.0-spark1.6 articulation.py [filename]
...
spark-submit --packages graphframes:graphframes:0.7.0-spark2.4-s_2.11 degree.py